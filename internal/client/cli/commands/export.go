...
func WriteResourcesCSV(w *csv.Writer, resources map[resource.ValJsonKey]resource.ValJson) (int, error) {
...
func WriteAuditCSV(w *csv.Writer, records []resource.AuditRecord) (int, error) {
...
func WriteHistoryCSV(w *csv.Writer, records []resource.HistoryRecord) (int, error) {
...
func WriteLogCSV(w *csv.Writer, records []resource.LogRecord) (int, error) {
