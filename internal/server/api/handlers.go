...
func requireStorage(w http.ResponseWriter, r *http.Request) corestorage.Storage {
	storage := storageFrom(r)
	if storage == nil {
		writeSysError(w, "storage not initialized")
	}
	return storage
}
