...
func TestLocalStorage_HistoryFunctions(t *testing.T) {
	...
	// 创建历史记录
	record1 := resource.HistoryRecord{
		ID:          1,
	...
	record2 := resource.HistoryRecord{
		ID:          2,
...
func TestJsonSerialization(t *testing.T) {
	...
	var keyDecoded resource.ValJsonKey
	...
	var valueDecoded resource.ValJson
